...
public class RowTest
{
    ...
    {
        Row row = new Row(new Color[]{Color.RED});
    ...
    {
        Row row = new Row(new Color[]{Color.RED, Color.RED, Color.RED, Color.RED});
    ...
    {
        Row row = new Row(new Color[]{Color.YELLOW, Color.YELLOW, Color.RED,
    ...
    {
        Row row = new Row(new Color[]{Color.YELLOW, Color.YELLOW, Color.YELLOW, Color.YELLOW});
        row.switchOnLamps(2);
    ...
    {
        Row row = new Row(new Color[]{Color.YELLOW, Color.YELLOW, Color.YELLOW, Color.YELLOW, Color.RED, Color.RED});
        row.switchOnLamps(6);
